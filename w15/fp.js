class FP {
    ...
    calculateTotal() {
        console.log("Household Points:", this.houseHoldPoints);
        console.log("House Size Points:", this.houseSizePoints);
        console.log("Food Type Points:", this.foodTypePoints);

        this.totalValue = this.houseHoldPoints + this.houseSizePoints + this.foodTypePoints;
    }
}
